...
<html lang="en">
  ...
  <form action="topupController.php" method="post">
    <div class="container">
      ...
      <h3> List Harga Chip</h3>
      <div class="item-box">
        <div class="item" onclick="toggleSelection(this)">
          <h3>60M Koin</h3>
          <p>Rp 7.000</p>
          <input type="radio" name="pesanan[]" value="60M Koin">
        </div>

        <div class="item" onclick="toggleSelection(this)">
          <h3>120M Koin</h3>
          <p>Rp 13.000</p>
          <input type="radio" name="pesanan[]" value="120M Koin">
        </div>

        <div class="item" onclick="toggleSelection(this)">
          <h3>200M Koin</h3>
          <p>Rp 21.000</p>
          <input type="radio" name="pesanan[]" value="200M Koin">
        </div>

        <div class="item" onclick="toggleSelection(this)">
          <h3>400M Koin</h3>
          <p>Rp 42.000</p>
          <input type="radio" name="pesanan[]" value="400M Koin">
        </div>

        <div class="item" onclick="toggleSelection(this)">
          <h3>1B Koin</h3>
          <p>Rp 81.000</p>
          <input type="radio" name="pesanan[]" value="1B Koin">
        </div>

        <div class="item" onclick="toggleSelection(this)">
            <h3>2B Koin</h3>
            <p>Rp 160.000</p>
            <input type="radio" name="pesanan[]" value="2B Koin">
          </div>
      </div>
